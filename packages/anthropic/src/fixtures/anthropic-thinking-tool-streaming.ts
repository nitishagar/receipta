...
export const anthropicThinkingToolStreaming = {
  ...
  streaming: true,
  sseText: [
    data({ type: "message_start", message: { id: "msg_tt", model: "claude-3-5-sonnet-20241022", usage: { input_tokens: 10 } } }),
    "",
    data({ type: "content_block_start", index: 0, content_block: { type: "thinking", thinking: "" } }),
    "",
    data({ type: "content_block_delta", index: 0, delta: { type: "thinking_delta", thinking: "Reasoning " } }),
    "",
    data({ type: "content_block_delta", index: 0, delta: { type: "thinking_delta", thinking: "about the weather." } }),
    "",
    ...
    "",
    data({ type: "content_block_delta", index: 2, delta: { type: "input_json_delta", partial_json: 'ation":"SF"}' } }),
    "",
