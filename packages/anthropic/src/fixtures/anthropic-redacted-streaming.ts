...
export const anthropicRedactedStreaming = {
  ...
  streaming: true,
  sseText: [
    data({ type: "message_start", message: { id: "msg_red", model: "claude-3-5-sonnet-20241022", usage: { input_tokens: 4 } } }),
    "",
    data({ type: "content_block_start", index: 0, content_block: { type: "redacted_thinking", data: "" } }),
    "",
    data({ type: "content_block_delta", index: 0, delta: { type: "redacted_thinking_delta", data: "blk_abc" } }),
    "",
    data({ type: "content_block_stop", index: 0 }),
    "",
    data({ type: "content_block_start", index: 1, content_block: { type: "text", text: "" } }),
    "",
    data({ type: "content_block_delta", index: 1, delta: { type: "text_delta", text: "after redaction" } }),
    "",
